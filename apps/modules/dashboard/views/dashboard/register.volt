...
<html lang="en">
 ...
 <section>
    ...
    <div class="container-login100" style="background-image: url('images/room-6.jpg');">
  ...
  <div class="row">
    ...
    <div class="wrap-input100 validate-input m-b-23" data-validate="Enter email">
      <input class="input100" type="email" name="email" placeholder="Email">
      <span class="focus-input100"></span>
    </div>

    <div class="wrap-input100 validate-input m-b-26" data-validate="Enter No Ktp">
      <input class="input100" type="text" name="no_ktp" placeholder="Nomor Ktp">
      <span class="focus-input100"></span>
    </div>

    <div class="wrap-input100 validate-input m-b-29" data-validate = "Enter password">
